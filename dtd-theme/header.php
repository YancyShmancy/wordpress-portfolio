	...
	<header id="masthead" class="site-header" role="banner">
		<div class="site-branding">
			...
			if ( is_front_page() && is_home() ) : ?>
				<h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a><span class="purple">.</span></h1>
			<?php else : ?>
				<h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a><span class="purple">.</span></h1>
			<?php
			endif;
...
<!--			<p>Hi! I’m Allison. I’m a full-stack developer from Atlanta, GA. I love comic books, binge watching TV shows, and making cool things.</p>-->
